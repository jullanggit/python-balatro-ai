...
JOKER_CLASSES = {
    ...
    AncientJoker: AncientJoker,
    WalkieTalkie: WalkieTalkie,
    Seltzer: Seltzer,
    SmileyFace: SmileyFace,
    GoldenTicket: GoldenTicket,
    SockAndBuskin: SockAndBuskin,
    HangingChad: HangingChad,
    RoughGem: RoughGem,
    ...
    HalfJoker: HalfJoker,
    JokerStencil: JokerStencil,
    CeremonialDagger: CeremonialDagger,
    Banner: Banner,
    MysticSummit: MysticSummit,
    LoyaltyCard: LoyaltyCard,
    Misprint: Misprint,
    SteelJoker: SteelJoker,
    AbstractJoker: AbstractJoker,
    GrosMichel: GrosMichel,
    Supernova: Supernova,
    ...
    Throwback: Throwback,
    GlassJoker: GlassJoker,
    FlowerPot: FlowerPot,
    SeeingDouble: SeeingDouble,
    Matador: Matador,
    TheDuo: TheDuo,
    TheTrio: TheTrio,
    TheFamily: TheFamily,
    ...
    Runner: Runner,
    GreenJoker: GreenJoker,
    SquareJoker: SquareJoker,
    Vampire: Vampire,
    Obelisk: Obelisk,
    LuckyCat: LuckyCat,
    SpareTrousers: SpareTrousers,
    Ramen: Ramen,
    Castle: Castle,
    WeeJoker: WeeJoker,
    ...
    FacelessJoker: FacelessJoker,
    MailInRebate: MailInRebate,
    TradingCard: TradingCard,
    BurntJoker: BurntJoker,
    FourFingers: FourFingers,
    CreditCard: CreditCard,
    MarbleJoker: MarbleJoker,
    ChaosTheClown: ChaosTheClown,
    DelayedGratification: DelayedGratification,
    ...
    SmearedJoker: SmearedJoker,
    Showman: Showman,
    MerryAndy: MerryAndy,
    OopsAllSixes: OopsAllSixes,
    InvisibleJoker: InvisibleJoker,
    Satellite: Satellite,
